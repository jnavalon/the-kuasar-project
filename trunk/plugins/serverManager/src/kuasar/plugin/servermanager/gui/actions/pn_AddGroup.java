...
public class pn_AddGroup extends kuasar.plugin.classMod.AbstractPanel {
    ...
    private void initComponents() {
        ...
        lbl_Error.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kuasar/plugin/servermanager/icons/forbidden.png"))); // NOI18N
    ...
    private void txt_nameCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txt_nameCaretUpdate
        ...
        if(txt_name.getText().trim().length() > 9){
            lbl_Error.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kuasar/plugin/servermanager/icons/bwarning.png")));
    ...
    private void accept(){
        ...
        if (panel.childExists(transformNodeName())) {
            lockANDnotify(true, "Group exists, Please check the name and try again.");
            return;
        }
        panel.addGroup(txt_name.getText().trim());
        close();
    }
    ...
    private void lockANDnotify(boolean activate, String error) {
        lbl_Error.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kuasar/plugin/servermanager/icons/forbidden.png")));
